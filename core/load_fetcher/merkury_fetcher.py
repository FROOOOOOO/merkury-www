...
class MerKuryFetcher(load_fetcher.LoadFetcher):
    """
    MerKury fetcher (bound to one pod/instance) for:
    ...
    def __str__(self) -> str:
        return (f'MerKury fetcher (node {self.node_name} ({self.node_addr}), container: {self.container} '
